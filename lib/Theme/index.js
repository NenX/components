...
var AntdThemeManipulator = function (props) {
    var _a = props.primaryColor, primaryColor = _a === void 0 ? '#1890ff' : _a, _b = props.storageName, storageName = _b === void 0 ? 'custom-antd-primary-color' : _b, _c = props.style, style = _c === void 0 ? {} : _c, _d = props.placement, placement = _d === void 0 ? null : _d, _e = props.onChange, onChange = _e === void 0 ? null : _e;
    var _f = react_1.useState(tinycolor2_1.default(primaryColor).toRgb()), color = _f[0], setColor = _f[1];
    var _g = react_1.useState(false), displayColorPicker = _g[0], setDisplayColorPicker = _g[1];
    ...
    return (react_1.default.createElement("div", { id: 'change_antd_theme_button', style: __assign(__assign({}, styles.swatch), style), onClick: handleClick },
        ...
        displayColorPicker
            ? react_1.default.createElement("div", { style: styles.popover },
                ...
                react_1.default.createElement(react_color_1.GithubPicker, { styles: { default: { card: { boxSizing: 'content-box' } } }, triangle: 'hide', color: color, onChange: handleChange, colors: colors })) : null));
};
exports.AntdThemeManipulator = AntdThemeManipulator;
